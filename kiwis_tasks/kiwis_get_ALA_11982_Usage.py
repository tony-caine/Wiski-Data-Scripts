...
def main():
    ...
    paths = ['AccessLicenceAccounts/11982*/AccUsage/FYear.Total', 'AccessLicenceAccounts/11982*/UncFlUsage/FYear.Total']
    start = '2010-01-01'
    end = '2020-12-01'
    input_number = 'RiverBalance/11982/LU_Total/FYear.Total'
    outputpath = r'D:\Kisters\scripts\kiwis_tasks\outputs'
    filename = 'ALA_11982_Usage'
