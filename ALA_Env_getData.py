...
xlWbFullPath = r'ALA_Env_config.xlsx'
...
zrxpfile = os.path.join(outputPath,'ALA_Env_data.zrxp')
...
def getAlaImportNumbersDict():
    ...
    ts_path_ala = 'AccessLicenceAccountsEnv/*/*/*'
    ala_ts = kiwis_ts()
...
def main():
    logging.basicConfig(filename='ALA_Env_getData.log',
